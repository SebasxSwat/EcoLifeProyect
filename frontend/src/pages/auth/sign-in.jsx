  ...
  return (
    <div className="bg-gradient-to-t from-gray-700 via-gray-900 to-black w-full h-screen flex flex-col lg:flex-row">
      ...
      <div className="flex flex-col items-start justify-center w-full lg:w-1/2 px-4 py-8 lg:pl-52">
        <h1 className="text-4xl font-bold text-white mb-16">Welcome Back!</h1>
        ...
        <div className="mt-8 w-full  flex items-center">
          <label htmlFor="no-account" className="text-slate-300 mr-1">
            Don’t have an account?
          </label>
          <a href="" className="text-blue-500 hover:underline mr-5">
            Sign Up
          </a>
        ...
        <div className="relative w-11/12 h-5/6 overflow-hidden rounded-lg mr-40">
          ...
          <div className="relative z-10 p-8 text-white">
            <h1 className="text-5xl font-bold mb-16 my-16">
              Sign in to your EcoLife account
            </h1>
            <p className="text-lg text-slate-200">
              Log in to your EcoLife account to continue where you left off.
            </p>
          </div>
        </div>
      </div>
